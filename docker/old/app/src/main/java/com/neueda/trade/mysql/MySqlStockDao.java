package com.neueda.trade.mysql;
...
public class MySqlStockDao implements StockDao {
   ...
   @Autowired
    ...
    public List<StockDto> findAll() {
        return this.tpl.query("select s.ticker, s.symbol, m.ticker as \"market\", s.description from " +
                "Stocks s inner join Markets m on s.market = m.ticker " +
    ...
    public Stock findById(String id) {
        List<StockDto> stocks = this.tpl.query(
                "select s.ticker, s.symbol, m.ticker as \"market\", s.description from " +
                "Stocks s inner join Markets m on s.market = m.ticker " +
