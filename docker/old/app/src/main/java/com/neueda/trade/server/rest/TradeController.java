...
public class TradeController {
    ...
    public String status() {
    	logger.info("REST status request");
        return "trade starter app running";
    }
    
    @SuppressWarnings("serial")
    @RequestMapping(value = "/version", method = RequestMethod.GET)
    public Map<String, String> version(@Value("${trade.server.version}") String version) {
    	logger.info("REST request for trade app version {}", version );
        return new HashMap<String, String>() {{put("version", version);}};
    }
	...
	public Trade place(@RequestParam Map<String,String> form) {
		...
		trade.setBuysell(Model.fromJson(String.format("\"%s\"",form.get("buysell")), BuySell.class));
    ...
    public TradeStats monitor() {
        return tradeMonitor.getStats();
    }
